...
<html>
<head>
<title>Edit <fmt:message key="order.title"/> <fmt:message key="channel.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveOrderChannel" method="POST" modelAttribute="channel">
